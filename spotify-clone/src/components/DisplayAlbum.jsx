...
const DisplayAlbum = ({album}) => {
  ...
  const {id}  = useParams(); //gets the parameter {id} when album is clicked that propagated to AlbumItem.jsx
  // console.log(id)

  // { } makes us take the "id" thats in id variable that is used in other component
